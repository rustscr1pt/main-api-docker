...
pub fn SESSION_DURATION() -> u16 { return env::var("SESSION_DURATION").unwrap().parse::<u16>().unwrap() }

pub fn DEPLOY_PORT() -> u16 {
    return env::var("DEPLOY_PORT").unwrap().parse::<u16>().unwrap()
}

pub fn FILE_LOCATION() -> String { return String::from(env::var("FILE_LOCATION").unwrap()) }

pub fn BOT_TOKEN_LOCATION() -> String { return String::from(env::var("BOT_TOKEN_LOCATION").unwrap()) }
